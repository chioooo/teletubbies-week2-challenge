# Semana 2 · Desafío Java: miniaplicación de consola bajo restricciones
...
de clases como stubs (firmas sin implementación).
...
└── src/
    ...
    │                                # Main — todos como stubs con TODOs
    └── test/java/org/example/      # CartTest: 4 pruebas nombradas y comentadas, sin cuerpo
```
